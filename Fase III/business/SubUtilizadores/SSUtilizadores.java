...
public class SSUtilizadores implements ISubUtilizadores{
    ...
    */
    public boolean validaAcesso(String email, String password){
        ...
        if(utilizadores.containsKey(email)){
            ...
            if(u.getPassword().equals(password)) res = true;
        }
    ...
    */
    ...
    Retorna null porque o utilizador não existe ou porque se trata de um administrador 
    */
    ...
    /* Regista pontuação do jogador para aquele campeonato, caso o jogador já tenha jogado naquele campeonato, atualiza a pontuação
    */
