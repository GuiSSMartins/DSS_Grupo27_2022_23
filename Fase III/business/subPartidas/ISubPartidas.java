...
public interface ISubPartidas {
	 ...
	 * @param carro
	 */
	void entrarNaPartida(String idBot, Piloto piloto, Carro carro);
	 ...
	 * @param idJogador
	 */
	boolean verificaDisponibilidadeAfinacoes(String idPartida, String idJogador);
}